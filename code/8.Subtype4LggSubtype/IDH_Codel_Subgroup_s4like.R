...
#########################TCGA
tcga.s4.data <- readRDS(file='D:/CancerNeuroscience/Github/data/LggRiskScores/tcga_lgg_risk_score.rds')
...
#########################CGGA-mRNAseq1
CGGAmRNAseq1.s4.data <- readRDS(file='D:/CancerNeuroscience/Github/data/LggRiskScores/plgg_693_risk_score.rds')
...
#########################CGGA-mRNAseq2
CGGAmRNAseq2.s4.data <- readRDS(file='D:/CancerNeuroscience/Github/data/LggRiskScores/plgg_325_risk_score.rds')
...
#########################CGGA-mRNA-array1
CGGAarray1.s4.data <- readRDS(file='D:/CancerNeuroscience/Github/data/LggRiskScores/plgg_301_risk_score.rds')
...
#########################GEO-mRNA-array3
GEOarray3.s4.data <- readRDS(file='D:/CancerNeuroscience/Github/data/LggRiskScores/plgg_GSE107850_risk_score.rds')
